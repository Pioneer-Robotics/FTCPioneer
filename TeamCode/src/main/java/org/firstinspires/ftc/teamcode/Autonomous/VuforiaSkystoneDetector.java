...
//        phoneYRotate = -90;
        ...
        final float CAMERA_FORWARD_DISPLACEMENT = 186;   // eg: Camera is 4 Inches in front of robot-center
        final float CAMERA_VERTICAL_DISPLACEMENT = 145;   // eg: Camera is 8 Inches above ground
        final float CAMERA_LEFT_DISPLACEMENT = 36;     // eg: Camera is ON the robot's center line
